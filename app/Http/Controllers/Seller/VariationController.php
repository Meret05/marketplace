...
use App\Http\Requests\Seller\Variation\StoreRequest;
use App\Http\Requests\Seller\Variation\UpdateRequest;
...
class VariationController extends Controller
{
    ...
    public function create($productId)
    {
        ...
        return view('seller.product-variation.create', compact('product', 'attributes'));
    }
