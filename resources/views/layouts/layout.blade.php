        ...
        <div class="container">
            <div class="row gy-3">
                ...
                <div class="col-lg-2 col-sm-4 col-4">
                    <a href="{{ route('client.home') }}" class="float-start">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" clip-rule="evenodd"
                             fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision"
                             text-rendering="geometricPrecision" viewBox="-.83 -.04 65.2 69.73">
                            <g fill="#3a589e">
                                <path
                ...
                <div class="order-lg-last col-lg-5 col-sm-8 col-8 ">
                    <ul class="nav justify-content-end">
                        <li class="nav-item">
                            <a class="nav-link text-dark-emphasis" href="{{ route('seller.products.index') }}">
                                {{ auth()->user() ? __('layout.my-store') : __('layout.create-store') }}
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark-emphasis" href="{{ route('client.catalogs.index') }}">
                                {{ __('layout.catalogs') }}
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark-emphasis"
                               href="{{ route('profile.edit') }}">{{ auth()->user() ? 'Profile' : __('layout.sign-in') }}
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('client.carts.index') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                     class="bi bi-cart mb-1 text-dark-emphasis" viewBox="0 0 16 16">
                                    <path
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" data-bs-toggle="dropdown" href="#" role="button"
                               aria-expanded="false">{!! __('layout.lang') !!}</a>
                            <ul class="dropdown-menu">
                                <li class="d-inline-block">
                                    <a class="dropdown-item" href="{{ route('lang.switch', ['locale' => 'en']) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                             id="flag-icons-um" viewBox="0 0 640 480">
                                            ...
                                            <path fill="none" marker-mid="url(#um-a)"
                                                  d="m0 0 16 11h61 61 61 61 60L47 37h61 61 60 61L16 63h61 61 61 61 60L47 89h61 61 60 61L16 115h61 61 61 61 60L47 141h61 61 60 61L16 166h61 61 61 61 60L47 192h61 61 60 61L16 218h61 61 61 61 60z"/>
                                        </svg>
                                    </a>
                                </li>
                                <li class="d-inline-block">
                                    <a class="dropdown-item" href="{{ route('lang.switch', ['locale' => 'tm']) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                             id="flag-icons-tm" viewBox="0 0 640 480">
                                ...
                                <li class="d-inline-block">
                                    <a class="dropdown-item" href="{{ route('lang.switch', ['locale' => 'ru']) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <div class="col-lg-5 col-md-12 col-12">
                    <div class="container-fluid">
                        ...
                        <form class="d-flex" action="{{ route('client.search') }}" method="GET">
                            <input name="search_field" value="{{ request('search_field') }}" type="text"
                                   class="form-control" placeholder="{{ __('layout.search') }}"
                                   aria-label="Search">
                            <button class="border-0 ms-1    bg-white" type="submit">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
<div class="d-flex flex-column min-vh-50">
    <footer class="mt-auto border-top text-center text-lg-start text-muted bg-white">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <ul class="list-unstyled mb-4">
                            ...
                            <li>{{ __('layout.number') }}: +99312345678</li>
                        </ul>
                    </div>
                    <div class="col">
                        <h6 class="text-uppercase text-dark fw-bold mb-2">
