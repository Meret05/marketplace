...
@section('seller')
    <div>
        ...
        <form action="{{ route('seller.attribute-values.store') }}" method="POST">
            @csrf
            <div>
                <div class="mb-4">
                    <input type="text" name="value" class="border border-gray-200 p-2 w-1/4" placeholder="{{ __('seller.value') }}">
                </div>
                <div class="mb-4">
